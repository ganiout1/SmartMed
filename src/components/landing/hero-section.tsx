  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute top-[-30px] right-[16px] w-[240px] lg:relative lg:top-auto lg:right-auto lg:w-auto lg:flex lg:justify-center lg:items-center lg:translate-x-[250px] lg:translate-y-[-300px]"
